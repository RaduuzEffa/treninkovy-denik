...
const Projects = (() => {
        ...
        <div class="proj-options-section proj-compact-row">
          ...
          <div class="proj-compact-col">
            <div class="proj-section-title" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:var(--s3)">
              <span><i class="icon icon-users"></i> Sportovci (${players.length}${project.capacity?' / '+project.capacity:''})</span>
              <button class="btn btn-ghost btn-sm" onclick="Players.showAddToProjectModal('${projectId}')">+</button>
            </div>
            ${players.length === 0
              ? `<button class="btn btn-secondary btn-sm" onclick="Players.showAddToProjectModal('${projectId}')">Přidat sportovce</button>`
    ...
    el.innerHTML = `
      ...
      <div class="detail-grid">
              ...
              <div class="section-card">
                <div class="table-wrap">
                  <table class="payment-table">
                    <thead><tr>
                      <th>Datum</th><th>Dny</th><th>Sportovec(i)</th><th>Částka</th><th>Status</th>
                    </tr></thead>
                    <tbody>
        ...
        <div>
          <div class="section">
            <div class="section-header">
              <h2 class="section-title"><i class="icon icon-users"></i> Sportovci (${players.length})</h2>
      ...
      `<div class="form">
        <div class="dup-preview">
          ...
          <div>
            ...
            <div class="dup-preview-meta">${App.fmtDateShort(s.date)} &nbsp;·&nbsp; <i class="icon icon-users"></i> ${Object.keys(s.playerPlans||{}).length} sportovců</div>
          </div>
        </div>
        <div class="form-group">
  ...
  function removePlayer(playerId, projectId) {
    ...
    App.showToast('Sportovec odebrán z projektu');
